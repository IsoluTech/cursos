  ...
  return (
    <nav className="w-full">
      ...
      <ul className="hidden lg:flex flex-col h-full pb-4 items-start">
        ...
        <li
          className={`w-full px-6 my-3 lg:my-2 ${selected === "Active" ? "bg-gradient-to-l from-violet-300 to-violet-500" : ""} hover:bg-violet-200 hover:bg-opacity-10 flex`}
        >
          <Button
            onClick={() => handleSelect("Active")}
            className="w-full bg-transparent shadow-none text-white hover:bg-transparent px-2 py-1 flex items-center justify-start gap-3 font-semibold text-xl lg:text-lg"
          >
            <BookCheck className="w-6 h-8" /> Cursos activos
          </Button>
        </li>
        <li
          className={`w-full px-6 my-3 lg:my-2 ${selected === "New" ? "bg-gradient-to-l from-violet-300 to-violet-500" : ""} hover:bg-violet-200 hover:bg-opacity-10 flex`}
        >
          <Button
            onClick={() => handleSelect("New")}
            className="w-full bg-transparent shadow-none text-white hover:bg-transparent px-2 py-1 flex items-center justify-start gap-3 font-semibold text-xl lg:text-lg"
          >
            <BookPlus /> Explorar nuevos cursos
          </Button>
        </li>
